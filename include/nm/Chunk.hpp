...
namespace nm
{
    class Chunk : public SquareSource
    {
      ...
      private:
        std::array<std::array<Square, NM_CHUNK_SIZE>, NM_CHUNK_SIZE>
            chunk {};  // {} necessary for 0-init
      public:
        ...
        {
            return std::all_of(chunk.begin(),
                               chunk.end(),
                               [&functor](const std::array<Square, NM_CHUNK_SIZE>& row) {
