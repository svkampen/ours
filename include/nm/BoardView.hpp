...
namespace nm
{
    ...
    class BoardView : public View
    {
      public:
         ...
         */
        BoardView(CursorData& cursorData, Window& main, Window& sidebar, const SquareEvent& open,
                  const SquareEvent& flag, const SquareEvent& move);
         ...
         * @param square The square in question.
         */
        void draw_open_square(int x, int y, Square& square, ChunkSquareSource& squareSource);
         ...
         * @param square The square in question.
         */
        void draw_closed_square(int x, int y, Square& square);
