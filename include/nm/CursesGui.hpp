...
namespace nm::curses
{
     ...
     *
     * This class sets up the terminal screen, manages data such as the cursors that need to be
     * drawn and manages its own cursor. Drawing the board/sidebar/etc is delegated to view classes,
